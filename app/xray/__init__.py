            ...
            storage[inbound_tag] = [
                {
                    ...
                    "packet": [i.strip() for i in host.packets.split(',')] if host.packets else [],
                    "length": [i.strip() for i in host.length.split(',')] if host.length else [],
                    "interval": [i.strip() for i in host.interval.split(',')] if host.interval else [],
